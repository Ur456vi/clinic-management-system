...
> **Note:** Aman (Legal Head) is not on this email — Varun and I will loop him in separately with the deferred-BAA memo and the DPA draft request. The Aman action items in the section below are for visibility; treat them as "what Algoborne will ask Aman next" rather than asks of you, Kunal.
