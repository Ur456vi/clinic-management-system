                        ...
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 space-y-6">
                                  ...
                                  <div className="flex items-start justify-between">
                                              <div className="flex items-center gap-4">
                                                            <div className="w-16 h-16 rounded-xl bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center">
                                                                            <span className="text-2xl font-bold text-indigo-600 dark:text-indigo-300">V</span>
                                                            </div>
                                                            <div>
                                                                            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Vyara Clinic</h2>
                                              ...
                                              <div className="text-right">
                                                            ...
                                                            <p className="text-sm text-gray-500 mt-1">Date: {selectedPrescription.date}</p>
                                              </div>
                                  </div>
                          ...
                          {/* Patient Information — uses logged-in patient's own data */}
                                  <div className="grid grid-cols-2 gap-6 border-t pt-4">
                                              <div>
                                                ...
                                                {profileLoading ? (
                                  <p className="text-sm text-gray-400">Loading patient info...</p>
                                ) : (
                                  <div className="space-y-2 text-sm">
                                                    ...
                                                    <div className="flex justify-between">
                                                                        <span className="text-gray-500">ID / Gender</span>
                                                                        <span className="font-medium text-gray-900 dark:text-white">
                          ...
                          {selectedPrescription.medicines && selectedPrescription.medicines.length > 0 && (
                              <div className="border-t pt-4">
                                            ...
                                            <table className="w-full text-sm">
                                                    ...
                                                    <tr key={med.sno}>
                                                                          <td className="px-3 py-2">{med.sno}</td>
                                                                          ...
                                                                          <td className="px-3 py-2">
                                                                                                  <span className="px-2 py-0.5 bg-gray-100 rounded text-xs">{med.timings}</span>
                                                                          </td>
                                                    </tr>
                                                  ))}
                                                            </tbody>
                          ...
                          {selectedPrescription.followUpDate && (
                              <div className="border-t pt-4 flex items-center gap-2 text-sm text-gray-600">
                                            <Calendar size={14} />
                                            <span>Follow Up Date: <strong>{selectedPrescription.followUpDate}</strong></span>
                              </div>
                                  )}
                        </div>
                </div>
                        ...
                        <table className="w-full text-sm">
                                  <thead className="bg-gray-50 dark:bg-gray-700 text-xs text-gray-500 uppercase tracking-wide">
                                              <tr>
                                                            ...
                                                            <th className="px-4 py-3 text-left">Prescribed On</th>
                          ...
                          <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-gray-750">
                                          ...
                                          <td className="px-4 py-3">
                                                            <div className="flex items-center gap-3">
                                                                                ...
                                                                                <div>
                                                                                                      <p className="font-medium text-gray-900 dark:text-white">{p.doctorName}</p>
                                                                                                      <p className="text-xs text-indigo-600">{p.specialty}</p>
                                                                                  </div>
                                                            </div>
                                          </td>
