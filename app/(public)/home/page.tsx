    ...
    return (
          <>
                            ...
                            <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full grid lg:grid-cols-2 gap-12 items-center py-16">
                                      <div>
                                                  <h1 className="text-4xl lg:text-6xl font-serif font-medium text-[#2C1A0E] leading-tight mb-6">
                                                                ...
                                                                <span className="text-[#7B1B2A] italic">Refuse to Normalize Decline</span>span>
                                                  </h1>h1>
                                                  ...
                                                  <div className="flex flex-wrap gap-8 text-xs font-bold tracking-widest text-[#5A4A3A]">
                                                                <span>20+ YEARS CLINICAL EXPERIENCE</span>span>
                                                                <span>PRECISION METABOLIC MEDICINE</span>span>
                                                                <span>HORMONAL & LONGEVITY CARE</span>span>
                                                  </div>div>
                                      </div>div>
                    ...
                    <section className="bg-white py-20">
                            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                                      <h2 className="text-3xl lg:text-5xl font-serif font-medium text-[#2C1A0E] mb-3">
                                                  ...
                                                  <span className="text-[#8B7355] italic">What You Are Experiencing</span>span>
                                      </h2>h2>
                                      <p className="text-[#5A4A3A] mb-10">You are functioning. But not at your best.</p>p>
                            ...
                            <li key={s} className="flex items-start gap-3 text-[#3A2C1E]">
                                              ...
                                              <span className="text-sm leading-relaxed">{s}</span>span>
                            </li>li>
                          ))}
                                                  </ul>ul>
                                                  <div>
                              ...
                              <li key={s} className="flex items-start gap-3 text-[#3A2C1E]">
                                                  ...
                                                  <span className="text-sm leading-relaxed">{s}</span>span>
                                                                ...
                                                                <p className="text-[#5A4A3A] text-sm mb-3 font-medium">And yet, you've been told:</p>p>
                                                                <ul className="space-y-2">
                                                                  {['"Everything looks normal."', '"It\'s just stress."', '"It\'s part of aging."'].map((q) => (
                              <li key={q} className="text-[#7B1B2A] italic text-sm">{q}</li>li>
                            ))}
                                                                </ul>ul>
                                                  </div>div>
                                      </div>div>
            ...
            {/* A DIFFERENT STANDARD OF CARE */}
                    <section className="bg-[#FAF8F3] py-20">
                            <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center">
                                      ...
                                      <div>
                                                  <h2 className="text-3xl lg:text-4xl font-serif font-medium text-[#2C1A0E] mb-6">A Different Standard of Care</h2>h2>
                                                  <div className="space-y-3 text-[#5A4A3A] mb-8 text-sm leading-relaxed">
                                                                <p>At this institute, care is not based on assumptions.</p>p>
                                                                <p>It is based on systems, structure, and precision.</p>p>
                                                                <p>We do not treat isolated symptoms.</p>p>
                                                                <p>We evaluate how your hormones, metabolism, and physiology interact as a whole.</p>p>
                                                  </div>div>
                            ...
                            <div key={item} className="border border-[#E8DDD0] rounded-lg p-4 text-xs font-medium text-[#5A4A3A] bg-white">{item}</div>div>
                          ))}
                                                  </div>div>
                                                  <div className="space-y-1 text-[#7B1B2A] font-semibold italic">
                                                                <p>No generic plans.</p>p>
                                                                <p>No unnecessary interventions.</p>p>
                                                                <p>Only precision-based medicine.</p>p>
                                                  </div>div>
                                      </div>div>
                            </div>div>
                    </section>section>
            ...
            {/* OUR CLINICAL FRAMEWORK */}
                    <section className="bg-white py-20">
                            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                                      <h2 className="text-3xl lg:text-4xl font-serif font-medium text-[#2C1A0E] text-center mb-16">Our Clinical Framework</h2>h2>
            ...
            { num: "04", title: "Imbalance Prevention", desc: "Imbalance begins years before it becomes clinically visible" },
                                        ...
                                        <div key={step.num} className="text-center p-6 border border-[#E8DDD0] rounded-xl bg-[#FAF8F3]">
                                                        <div className="text-4xl font-serif font-light text-[#C9B8A8] mb-4">{step.num}</div>div>
                                                        <h3 className="font-semibold text-[#2C1A0E] text-sm mb-2">{step.title}</h3>h3>
                                                        <p className="text-xs text-[#8B7355] leading-relaxed">{step.desc}</p>p>
                                        </div>div>
                                      ))}
                                      </div>div>
                            </div>div>
            ...
            {/* SERVICES OVERVIEW */}
                    <section className="bg-[#FAF8F3] py-20">
                            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                                      <h2 className="text-3xl lg:text-4xl font-serif font-medium text-[#2C1A0E] text-center mb-4">Our Clinical Programs</h2>h2>
                                      <p className="text-center text-[#8B7355] mb-12 text-sm">Each program is built around your physiology, not a template.</p>p>
                          ...
                          <Link key={card.href} href={card.href} className="group bg-white border border-[#E8DDD0] rounded-xl p-6 hover:border-[#7B1B2A] hover:shadow-md transition-all">
                                          <div className="text-[10px] font-bold tracking-widest text-[#7B1B2A] uppercase mb-3">{card.tag}</div>div>
                                          <h3 className="font-serif text-[#2C1A0E] font-medium mb-4 group-hover:text-[#7B1B2A] transition-colors">{card.title}</h3>h3>
                                          <span className="text-xs text-[#8B7355] flex items-center gap-1">Learn More <ArrowRight size={12} /></span>span>
                          </Link>Link>
                        ))}
                                      </div>div>
                            </div>div>
            ...
            {/* CTA */}
                    <section className="bg-[#7B1B2A] py-20">
                            <div className="max-w-3xl mx-auto px-6 text-center">
                                      <h2 className="text-3xl lg:text-4xl font-serif text-white mb-4">Begin With A Clinical Assessment</h2>h2>
                                      <p className="text-[#E8C8C0] mb-8 text-sm leading-relaxed">Start your physician-led biological evaluation. Take our health assessment questionnaire to understand how your biology is functioning.</p>p>
                                      <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                                  <Link href="/quiz" className="bg-white text-[#7B1B2A] font-semibold px-8 py-4 rounded hover:bg-[#FAF8F3] transition-colors">Take Health Assessment</Link>Link>
                                                  <Link href="/contact" className="border-2 border-white text-white font-semibold px-8 py-4 rounded hover:bg-white hover:text-[#7B1B2A] transition-colors">Book Consultation</Link>Link>
                                      </div>div>
                            </div>div>
                    </section>section>
          </>>
