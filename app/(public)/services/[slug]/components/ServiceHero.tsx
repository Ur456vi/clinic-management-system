  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 top-0 bottom-0 w-full lg:w-[60%] pointer-events-none z-0">
         ...
         {/* Doctor Image (Placeholder assumes the user has the asset at this path) */}
         <img 
           src="/images/landing/doctor-hero.png" 
           alt="Doctor"
           className="absolute bottom-0 right-[15%] lg:right-[20%] xl:right-[25%] h-[80%] lg:h-[95%] object-contain object-bottom hidden md:block"
         />
      ...
      <div className="mx-auto max-w-[1440px] px-6 pt-12 pb-16 md:px-12 md:pt-16 md:pb-20 relative z-10">
        <div className="w-full lg:w-[55%]">
          ...
          <p
            className="mt-6 max-w-[500px] text-[14px] md:text-[15px] leading-relaxed"
            style={{ color: "black" }}
          >
            {svc.heroBody.split("\n").map((line, idx) => (
