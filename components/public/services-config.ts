...
export const SERVICES: ServiceContent[] = [
  ...
  },
  {
    ...
    programTag: "PHYSIOLOGY. APPEARANCE. LONGEVITY.",
    heroTitle: "Aesthetic Medicine & External Restoration",
    heroTitleAccent: "Programs",
    heroBody:
      "Changes in appearance often reflect physiological / Hormonal changes occurring beneath the surface long before disease becomes apparent.",
    heroImage: "/images/landing/service-aesthetic-external-hero.png",
    heroQuote: {
      text: "Appearance Is Physiology Made Visible. The skin, connective tissue, hair, and facial architecture often reflect hormonal, metabolic, inflammatory, vascular, and age-related physiological processes.",
    },
    heroTiles: [
      { icon: "sparkle", label: "Physiological Balance" },
      { icon: "leaf", label: "Healthy Tissue Aging" },
      { icon: "heart", label: "Connective Tissue Integrity" },
      { icon: "shield", label: "Natural Regeneration" },
      { icon: "clock", label: "Long-Term Tissue Health" },
    ],
    symptomsSection: {
      ...
      body: "",
      items: [
        { icon: "scale", label: "Hormonal Regulation" },
        { icon: "shield", label: "Chronic Inflammation" },
        { icon: "leaf", label: "Metabolic Dysfunction" },
        { icon: "sparkle", label: "Oxidative Stress" },
        { icon: "heart", label: "Microvascular Integrity" },
        { icon: "clock", label: "Sleep & Recovery Physiology" },
        { icon: "target", label: "Nutritional Sufficiency" },
        { icon: "chart", label: "Connective Tissue Aging" },
        { icon: "brain", label: "Neuroendocrine Stress" },
      ],
    },
    conventionalSection: {
      title: "Aesthetic Medicine Within A Physiological Framework.",
      ...
      callout: {
        ...
        body: "The objective is not superficial transformation. The objective is restoration, structural support, and preservation.",
      },
    },
    approachSection: {
      title: "Clinical Aesthetic & Regenerative Interventions May Include:",
