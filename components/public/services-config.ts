  ...
  },
  {
    ...
    conventionalSection: {
      ...
      callout: {
        ...
        body: "There is no interest in exaggerated or unnatural outcomes. Every intervention is approached conservatively, structurally, and in alignment with the individual's physiology, facial architecture, and long-term health.",
      },
    },
    approachSection: {
      ...
      steps: [
        { icon: "stethoscope", title: "Physician-guided skin care protocols" },
        ...
        { icon: "clock", title: "Pigmentation & aging support" },
      ],
    },
  },
];
