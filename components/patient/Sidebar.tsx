...
const menuItems = [
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
        <path d="M3 14a9 9 0 0118 0" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M12 14l4-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <circle cx="12" cy="14" r="1.5" stroke="currentColor" strokeWidth="2" />
        <path d="M3 14v3a1 1 0 001 1h16a1 1 0 001-1v-3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </svg>
    ),
  },
];
