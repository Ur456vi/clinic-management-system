  ...
  return (
    <div className="p-6 lg:p-8 flex flex-col gap-6 max-w-[1200px] mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#101828]">Profile Settings</h1>
      ...
      <div className="bg-white rounded-xl border border-[#EAECF0] shadow-sm overflow-hidden">
        ...
        <div className="p-6 lg:p-8">
          ...
          {tab === "password" ? <PasswordTabStub /> : null}
          {tab === "notifications" ? <NotificationsTabStub /> : null}
        </div>
      </div>
    ...
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-[#667085]">{sub}</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <Field label="Account Email">
            <input
              ...
              value={profile.email}
              disabled
              className={`${inputCls} bg-[#F9FAFB] text-[#667085]`}
            />
          </Field>
      ...
      {profile.kind === "staff" ? (
        <section className="flex flex-col gap-6">
          ...
          <h2 className="text-base font-bold text-[#141414]">Professional Information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
  ...
  return (
    <div className="flex flex-col gap-3 text-sm">
      ...
      <p className="text-[#667085] max-w-md">
        Password change is handled via the password-reset flow today. Click the
        link below to reset your password through email verification.
      </p>
      <Link
...
function NotificationsTabStub() {
  return (
    <div className="flex flex-col gap-3 text-sm">
      ...
      <p className="text-[#667085] max-w-md">
        Notification preferences are coming soon. For now, you&apos;ll receive
        email alerts for appointment confirmations, lab results, and prescription
        updates by default.
      </p>
    </div>
  );
